  ...
  return (
    <section id="Contact">
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[40%_60%] xl:grid-cols-[30%_70%] my-14 space-x-5">
          <div className="w-full md:w-[70%] lg:w-full relative my-8 lg:my-0  rounded-3xl mx-auto  p-6 space-y-4 text-white/75  bg-gradient-to-t from-gray-1000 via-gray-800 to-transparent shadow-[0px_5px_24px_0px_rgba(253,253,253,0.2)]">
