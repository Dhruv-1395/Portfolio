...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className="py-2 px-4 flex justify-between items-center z-50 transition-all duration-300 sticky top-0  shadow"
        id="Navbar"
      >
        ...
        {togglemenu ? (
          <div
            className="cls-menu text-white text-5xl hidden max-[900px]:block cls-btn-anime"
          ...
          <div
            className="toggle-btn text-white text-4xl hidden max-[900px]:block cursor-pointer"
